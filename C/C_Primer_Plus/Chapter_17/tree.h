...
// 操作:在树中添加一个项
// 前提条件:pi是待添加项的地址  ptree指向一个已经初始化的数
// 如果可以添加,该函数将在树中添加一个项并返回true,否则,返回false
bool AddItem(const Item * pi,Tree * ptree);

// 操作:在树中查找一个项
// 前提条件:pi指向一个项    ptree指向一个已初始化的数
...
// 操作:将函数应用于树中的每一项
// 前提条件:ptree指向一个数,pfun指向一个函数,该函数接受一个Item类型的参数,并无返回值
// 后置条件:pfun指向的这个函数对树中的每一项执行一下
