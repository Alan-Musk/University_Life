class VendingMachine:
    ...
    def vend(self):
        if self.num==0:
            ...
            self.balance,self.num=0,self.num-1
    ...
    def restock(self,num):
        self.num+=num
        return 'Current {0} stock: {1}'.format(self.product_name,self.num)
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        if (Mint.current_year-self.year)<50: # 如果年份小于50
            return Mint.current_year-self.year+type(self).cents
        return Mint.current_year-self.year+type(self).cents-50
