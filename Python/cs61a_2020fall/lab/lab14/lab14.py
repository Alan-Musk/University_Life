...
class CheckingAccount(Account):
    ...
    "*** YOUR CODE HERE ***"
    def deposit_check(self,obj):
        if self.holder!=obj.holder:
            ...
            obj.deposited=True
            return self.deposit(obj.balance)
...
def filterl(lst, pred):
    ...
    "*** YOUR CODE HERE ***"
    ls=[]
    ls+=foldl(Link(0,Link.empty),pred,lst.first)
    return ls
